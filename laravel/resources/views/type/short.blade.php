	...
	<div class="services">
		<div class="container">
			...
			<div class="service-grids">
				<div class="col-md-4 service-grid">
					<div class="service-grd wow fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="300ms">
						<img src="houst_img/(16).jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 service-grid">
					<div class="service-grd wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
						<img src="houst_img/(17).jpg" alt=" " class="img-responsive" />
						<div class="service-grd-pos">
							<h4>eum fugiat quo nulla</h4>
							<div class="more m2">
								<a href="single.html" class="hvr-curl-bottom-right">Read More</a>
				...
				<div class="col-md-4 service-grid">
					<div class="service-grd wow fadeInRightBig" data-wow-duration="1000ms" data-wow-delay="300ms">
						<img src="houst_img/(18).jpg" alt=" " class="img-responsive" />
						<div class="service-grd-pos">
							<h4>eum fugiat quo nulla</h4>
							<div class="more m2">
								<a href="single.html" class="hvr-curl-bottom-right">Read More</a>
			...
			<div class="service-grids">
				<div class="col-md-4 service-grid">
					<div class="service-grd wow fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="300ms">
						<img src="houst_img/(19).jpg" alt=" " class="img-responsive" />
						<div class="service-grd-pos">
							<h4>eum fugiat quo nulla</h4>
							<div class="more m2">
								<a href="single.html" class="hvr-curl-bottom-right">Read More</a>
				...
				<div class="col-md-4 service-grid">
					<div class="service-grd wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
						<img src="houst_img/(20).jpg" alt=" " class="img-responsive" />
						<div class="service-grd-pos">
							<h4>eum fugiat quo nulla</h4>
							<div class="more m2">
								<a href="single.html" class="hvr-curl-bottom-right">Read More</a>
				...
				<div class="col-md-4 service-grid">
					<div class="service-grd wow fadeInRightBig" data-wow-duration="1000ms" data-wow-delay="300ms">
						<img src="houst_img/(21).jpg" alt=" " class="img-responsive" />
						<div class="service-grd-pos">
							<h4>eum fugiat quo nulla</h4>
							<div class="more m2">
								<a href="single.html" class="hvr-curl-bottom-right">Read More</a>
